...
import AboutSectionStudentLeader from "@/components/About/AboutSectionStudentLeader";
import Breadcrumb from "@/components/Common/Breadcrumb";
// import WhyHero from "@/components/WhyHero";
// import backgroundImage from "../../public/images/features/int.jpg";

const AboutStudentLeader = () => {
  return (
    <>
      {/* <WhyHero /> */}
      <Breadcrumb
        pageName="Student Leadership"
        description="
      ...
      />
      {/* <AboutSectionSix /> */}
      <AboutSectionStudentLeader />
    </>
  );
};

export default AboutStudentLeader;
