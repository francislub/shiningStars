...
import AboutSectionAdministrators from "@/components/About/AboutSectionAdministrators";
import Breadcrumb from "@/components/Common/Breadcrumb";
// import WhyHero from "@/components/WhyHero";
// import backgroundImage from "../../public/images/features/int.jpg";

const AboutAdministrators = () => {
  return (
    <>
      {/* <WhyHero /> */}
      <Breadcrumb
      ...
      />
      {/* <AboutSectionSix /> */}
      <AboutSectionAdministrators />
    </>
  );
};

export default AboutAdministrators;
