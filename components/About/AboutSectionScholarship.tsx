  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-8">Shining Stars Scholarship Program</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            <h3 className="text-2xl font-semibold mb-4">About Our Scholarship</h3>
            <p className="mb-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-16">
          <h3 className="text-2xl font-semibold mb-6">Scholarship Requirements</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h4 className="text-xl font-semibold mb-2">Full Tuition Coverage</h4>
            <p>100% of tuition fees covered for the duration of primary education</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <CashIcon className="w-12 h-12 text-green-500 mb-4" />
            <h4 className="text-xl font-semibold mb-2">Book Allowance</h4>
            <p>Annual allowance for textbooks and essential school supplies</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <UserGroupIcon className="w-12 h-12 text-purple-500 mb-4" />
            <h4 className="text-xl font-semibold mb-2">Mentorship Program</h4>
            <p>One-on-one guidance from experienced educators and professionals</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <ClipboardCheckIcon className="w-12 h-12 text-red-500 mb-4" />
            <h4 className="text-xl font-semibold mb-2">Enrichment Activities</h4>
            <p>Access to exclusive workshops, field trips, and learning experiences</p>
          </div>
        </div>
      </div>
    </section>
