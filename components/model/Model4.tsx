...
const Model4 = ({ is4visible, onClose, children }) => {
  ...
  const touch = () => {
    ...
    document.getElementById("why-bugema-more").classList.add("hidden");
    document
      .getElementById("attachment-get-in-toch")
      ...
      <div className=" fade-in fixed z-40 inset-0 backdrop-blur-sm flex ml-[5%] mt-[9%] w-[90%] h-[70%]  rounded-lg overflow-auto overflow-x-hidden bg-white" id="wrapper" onMouseLeave={onClose}  >                  
        ...
        <div id="programs">
          <div
            ...
            style={{ marginLeft: "115px", marginTop: "25%" }}
          >
            {/* M  A  P */}
            <div className="mr-2 my-5 slider slide--fast">
              <h1
                ...
                className="animated font-bold main "
              >
                {" "}
                <span className="animated">Directions</span>
              </h1>
            </div>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15958.473363353443!2d32.6470728!3d0.5736614!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177c49393fb44457%3A0x364fc7d728083562!2sshining%20stars%20nursery%20and%20primary%20school%20-%20Vvumba!5e0!3m2!1sen!2sug!4v1720496544469!5m2!1sen!2sug"
              width="500"
              height="300"
              style={{ border: 0 }}
            ...
            ></iframe>
            {/* <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.6206770744043!2d32.64117747432078!3d0.5703006635869016!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177c4be209db538d%3A0xe4ac675b7d218fc9!2sBugema%20School!5e0!3m2!1sen!2sug!4v1718632251835!5m2!1sen!2sug" width="500" height="300" style={{border:0}} allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade">
                                    </iframe> */}
            ...
            <div
              id="attachment-courses"
              className="slant-div-right bg-black hidden text-white grid-rows-2"
              style={{ marginTop: "9%", width: "111%", height: "40%" }}
            >
              <div className="fade-in">
                ...
                <Image
                  ...
                  width={550}
                  height={450}
                  className="fade-in-slow transform -skew-x-12 '"
                />
              </div>
            </div>
          </div>
        ...
        <div
          className=" ml-20 vertical-line  transform -skew-x-12 "
          style={{ marginTop: "12%" }}
        ></div>
        ...
        <div className="ml-10  my-20 transform" id="IT">
          ...
          <div className="fade-in" id="touch-more">
            ...
            <div
              className="ml-19 mr-5 transform -skew-x-11 text-white grid-rows-2 fade-in "
              style={{ marginTop: "-7%" }}
            >
            ...
            <div
              className="ml-24 -mr-3 my-2 transform text-white grid-rows-2 "
